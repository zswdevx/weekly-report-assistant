import { Button, Card, Flex, Form, Input, InputNumber, message, Modal, Popconfirm, Table, Tag } from 'antd'
    ...
    <>
      ...
      <Modal title={isEdit ? '编辑' : '添加'} open={modalOpen} onCancel={onCancel} onOk={form.submit} destroyOnClose>
        <Form
          ...
          onFinish={onFinish}
          preserve={false}
          initialValues={{ sort: 0, branches: ['master'] }}
        >
